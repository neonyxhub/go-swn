...
type DeviceAuthRequest struct {
	...
	SenderDevPubKey []byte `protobuf:"bytes,2,opt,name=SenderDevPubKey,proto3" json:"SenderDevPubKey,omitempty"`
}
...
func (x *DeviceAuthRequest) GetSenderDevPubKey() []byte {
	if x != nil {
		return x.SenderDevPubKey
	}
	return nil
}
